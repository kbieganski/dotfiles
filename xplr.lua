...
xplr.config.layouts.builtin.help_sel = {
  Horizontal = {
    config = {
      constraints = {
        { Percentage = 70 },
...
--
-- Type: [Layout](https://xplr.dev/en/layout)
xplr.config.layouts.builtin.help = {
  Horizontal = {
    config = {
      constraints = {
        { Percentage = 70 },
...
--
-- Type: [Layout](https://xplr.dev/en/layout)
xplr.config.layouts.builtin.none = {
  Vertical = {
    config = {
      constraints = {
        { Length = 3 },
...
xplr.config.modes.builtin.switch_layout = {
  ...
  key_bindings = {
    on_key = {
      ...
      ["2"] = {
        help = "no help no selection",
        messages = {
          { SwitchLayoutBuiltin = "none" },
          "PopMode",
        },
      },
      ["3"] = {
        help = "help",
        messages = {
          { SwitchLayoutBuiltin = "help" },
          "PopMode",
        },
      },
      ["4"] = {
        help = "help and selection",
        messages = {
          { SwitchLayoutBuiltin = "help_sel" },
          "PopMode",
        },
      },
    },
